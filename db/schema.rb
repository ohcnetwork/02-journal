...
ActiveRecord::Schema.define(version: 2021_05_29_161620) do
  ...
  create_table "cylinder_locations", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "station_id"
    t.uuid "cylinder_id"
    t.integer "status"
    t.integer "capacity"
    t.integer "entry_exit"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
  end

  create_table "cylinders", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    t.uuid "vendor_id"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
